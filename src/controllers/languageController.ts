        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "You are using an invalid extension. Please download the correct extension from the Chrome Web Store. Click <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>here</a> to download the correct extension.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Sie verwenden eine ungültige Erweiterung. Bitte laden Sie die richtige Erweiterung aus dem Chrome Web Store herunter. Klicken Sie <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>hier</a> um die richtige Erweiterung herunterzuladen.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Está utilizando una extensión no válida. Descargue la extensión correcta de Chrome Web Store. Haga clic en <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>aquí</a> para descargar la extensión correcta.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "از افزونه نامعتبر استفاده می کنید. لطفا افزونه صحیح را از نت بازار Chrome بارگیری کنید. کلیک کنید <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>اینجا</a> برای دانلود پسوند صحیح.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Vous utilisez une extension non valide. Veuillez télécharger l’extension correcte depuis le Chrome Web Store. Cliquez sur <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>ici pour télécharger l’extension</a> correcte.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Si sta utilizzando un'estensione non valida. Scarica l'estensione corretta dal Chrome Web Store. Fai clic su <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>qui</a> per scaricare l'estensione corretta.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "ਤੁਸੀਂ ਇੱਕ ਗੈਰ-ਕਾਨੂੰਨੀ ਐਕਸਟੈਂਸ਼ਨ ਦੀ ਵਰਤੋਂ ਕਰ ਰਹੇ ਹੋ। ਕਿਰਪਾ ਕਰਕੇ Chrome ਵੈੱਬ ਸਟੋਰ ਤੋਂ ਸਹੀ ਐਕਸਟੈਂਸ਼ਨ ਡਾਊਨਲੋਡ ਕਰੋ। ਸਹੀ ਐਕਸਟੈਂਸ਼ਨ ਨੂੰ ਡਾਊਨਲੋਡ ਕਰਨ ਲਈ ਇੱਥੇ <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' ਨਿਸ਼ਾਨਾ='_blank'>ਇੱਥੇ ਕਲਿੱਕ</a> ਕਰੋ।",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Você está usando uma extensão inválida. Faça o download da extensão correta na Chrome Web Store. Clique em <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>aqui</a> para baixar a extensão correta.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Вы используете недействительное расширение. Загрузите соответствующее расширение из Интернет-магазина Chrome. Нажмите <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>здесь</a>, чтобы загрузить правильное расширение.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Ви використовуєте невірне розширення. Будь ласка, завантажте правильне розширення з Chrome Web Store. Натисніть <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>тут</a>, щоб завантажити правильне розширення.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "Geçersiz bir uzantı kullanıyorsunuz. Lütfen Chrome Web Mağazası'ndan doğru uzantıyı indirin. Doğru uzantıyı indirmek için <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'> buraya tıklayın</a>.",
        ...
        "error": {
          ...
          "message": {
            "server": {
              ...
              "invalid_signature": "您正在使用无效的扩展。请从 Chrome Web Store 下载正确的扩展。点击 <a href='https://chromewebstore.google.com/detail/bmihdnoolhjbhjcoiamedcghafihcooi' target='_blank'>here</a> 下载正确的扩展。",
